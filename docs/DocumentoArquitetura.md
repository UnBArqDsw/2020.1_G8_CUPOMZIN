...
sistemas de software e fornecem um conjunto de subsistemas pré definidos, especificando suas responsabilidades e incluindo regras e diretrizes para organizar as relações entre eles. Sendo o MVC o padrão arquitetural escolhido para o projeto.
...
## Visão de Dados
• A Visão de Dados mostra como esta arquiteturada a camada de persistência do projeto, mapeando os objetos e os modelos de dados.
